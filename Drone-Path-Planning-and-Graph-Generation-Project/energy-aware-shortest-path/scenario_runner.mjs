...
import { runModifiedDijkstra, runStandardDijkstra, runBellmanFord, DEFAULT_ENVIRONMENT } from "./js/algorithms.js";
...
for (const scenario of PRESET_SCENARIOS) {
  ...
  console.log(
    `DP (Bellman)| distance=${format(dp.totalDistance)} energy=${format(dp.totalEnergyCost)} time_ms=${format(
      dp.executionTimeMs,
      6,
    )}`,
  );
